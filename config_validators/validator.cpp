...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        std::string strFerXMLSchemaPath = "";
        ...
        for (int i = 1; i < argc; ++i)
        {
            ...
            {
                strFerXMLSchemaPath = argv[++i];
                std::cout << "ferxml xsd path set to: " << strFerXMLSchemaPath << std::endl;
            }
        ...
        if (strFerXMLSchemaPath.empty())
        {
            std::cerr << "Error: no fersxml.xsd schema file given, run with -h\n";
            return 1;
        }
        ...
        std::cout << "Attempting to set xsd namespace: " + strFerXMLSchemaPath << std::endl;
        parser.setExternalNoNamespaceSchemaLocation(strFerXMLSchemaPath.c_str());
        std::cout << "Wohoo! Success!" << std::endl;
        ...
        {
            // error should have been printed by parser
            std::cout << "XML parsing encountered errors - see above" << std::endl;
            return 1;
        }
